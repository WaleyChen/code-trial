...
class VoiceController < ApplicationController
    ...
    def recordVoice
        ...
        render xml: "
            <Response>
                <Record timeout=\"60\" transcribe=\"true\" action=\"http://codetriallive.herokuapp.com/finishedRecording\" transcribeCallback=\"http://codetriallive.herokuapp.com/transcribeCallback\" />
            </Response>"
    end
    ...
    def finishedRecording
        ...
        interview.voice_duration = params[:RecordingDuration]
        interview.save
